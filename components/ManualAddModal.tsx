// FIX: Imported `useEffect` to resolve error.
                ...
                <div className="space-y-3">
                  {formData.doses.map((dose, index) => (
                    <div key={index} className="grid grid-cols-12 gap-x-3 items-center">
                        <div className="col-span-12 sm:col-span-3"><input type="text" name="dose" placeholder="剂量 (e.g., 5mg)" value={dose.dose} onChange={e => handleDoseChange(index, e)} className={formInputStyle + " mt-0"} required/></div>
